    ...
    <main>
      <div className="container mx-auto py-20 px-4">
        ...
        <section>
          ...
          <p>
            We are MonClips inc. (<b>&quot;Company,&quot;</b>{" "}
            <b>&quot;we,&quot;</b> <b>&quot;us,&quot;</b> <b>&quot;our&quot;</b>
            ), a company registered in Delaware, United States at 8 The Green,
            Dover, DE 19901, USA, Dover, DE 19901. <br />
            <br />
            We operate the website{" "}
            <a href="https://monclips.com">https://monclips.com</a> (the{" "}
            <b>&quot;Site&quot;</b>), the mobile application MonClips Gallery
            (the <b>&quot;App&quot;</b>), as well as any other related products
            and services that refer or link to these legal terms (the{" "}
            <b>&quot;Legal Terms&quot;</b>) (collectively, the{" "}
            <b>&quot;Services&quot;</b>). <br />
            ...
            USA, Dover, DE 19901, United States. <br />
            <br />
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (
            <b>&quot;you&quot;</b>), and MonClips inc., concerning your access
            ...
            YOU MUST DISCONTINUE USE IMMEDIATELY. <br />
            <br />
            ...
            effective upon posting or notifying you by support@monclips.com, as
        ...
        <section>
          ...
          <ol className="list-decimal list-inside">
            ...
            <li>
              <a href="#reviews">GUIDELINES FOR REVIEWS</a>
            </li>
            <li>
        ...
        <section id="purchases">
          ...
          <ul style={{ marginLeft: "20px" }}>
            <li>- In-App Purchase Apple App Store</li>
            <li>- In-App Purchase Google Play Store</li>
          </ul>
          <br />
          <p>
        ...
        <section id="subscriptions">
          ...
          <p>
            ...
            <b>Cancellation</b>
            <br />
            Subscriptions can be canceled through the platform where the
            purchase was made: For iOS (Apple) users: Go to Settings {">"} tap
            your Apple ID {">"} Subscriptions {">"} select the subscription you
            want to manage {">"} tap Cancel Subscription. For Android (Google
            Play) users: Open the Google Play Store app {">"} tap the profile
            icon {">"} Payments & subscriptions {">"} Subscriptions {">"} select
            the subscription you want to cancel {">"} tap Cancel Subscription.
            Please note that deleting the app does not cancel your subscription.
            You must cancel it manually via the respective store to avoid
            further charges. Your cancellation will take effect at the end of
            the current paid term. If you have any questions or are unsatisfied
            with our Services, please email us at support@monclips.com. <br />
            <br />
            <b>Fee Changes</b>
            <br />
        ...
        <section id="prohibited">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              Uploading, sharing, or distributing any content that is offensive,
              violent, sexually explicit, or otherwise inappropriate
            </li>
            <li>
              Attempting to gain unauthorized access to other users&apos;
              accounts or engaging in any form of fraudulent activity
            </li>
            <li>
              Using the platform in any manner that is inconsistent with its
              intended purpose or in violation of applicable laws and
              regulations
            </li>
          </ul>
        </section>
        ...
        <section id="reviews">
          <h2 className="mb-4 text-2xl">
            <Link href="#reviews">11. GUIDELINES FOR REVIEWS</Link>
          </h2>
          <p>
        ...
        <section id="mobile">
          <h2 className="mb-4 text-2xl">
            <Link href="#mobile">12. MOBILE APPLICATION LICENSE</Link>
          </h2>
          <p>
            <b>Use License</b>
            <br />
            ...
            with the App. <br />
            <br />
            <b>Apple and Android Devices</b> <br />
        ...
        <section id="socialmedia">
          <h2 className="mb-4 text-2xl">
            <Link href="#socialmedia">13. SOCIAL MEDIA</Link>
          </h2>
          <p>
        ...
        <section id="ppyes">
          ...
          <p>
            ...
            advised the Services are hosted in the United States and Germany. If
            ...
            disclosure that differ from applicable laws in the United States and
            Germany, then through your continued use of the Services, you are
            transferring your data to the United States and Germany, and you
        ...
        <section id="copyrightyes">
          <h2 className="mb-4 text-2xl">
            <Link href="#copyrightyes">16. COPYRIGHT INFRINGEMENTS</Link>
          </h2>
          <p>
        ...
        <section id="terms">
          <h2 className="mb-4 text-2xl">
            <Link href="#terms">17. TERM AND TERMINATION</Link>
          </h2>
          <p>
        ...
        <section id="law">
          <h2 className="mb-4 text-2xl">
            <Link href="#law">19. GOVERNING LAW</Link>
          </h2>
          <p>
            These Legal Terms shall be governed by and defined following the
            laws of Kazakhstan. MonClips inc. and yourself irrevocably consent
            that the courts of Kazakhstan shall have exclusive jurisdiction to
        ...
        <section id="disputes">
          <h2 className="mb-4 text-2xl">
            <Link href="#disputes">20. DISPUTE RESOLUTION</Link>
          </h2>
          <p>
            ...
            arbitration shall be Almaty, Kazakhstan. The language of the
            proceedings shall be English. The governing law of these Legal Terms
            shall be substantive law of Kazakhstan. <br />
            <br />
            <b>Restrictions</b>
            <br />
            ...
            the general public or any other persons. <br />
            <br />
        ...
        <section id="corrections">
          <h2 className="mb-4 text-2xl">
            <Link href="#corrections">21. CORRECTIONS</Link>
          </h2>
          <p>
        ...
        <section id="disclaimer">
          <h2 className="mb-4 text-2xl">
            <Link href="#disclaimer">22. DISCLAIMER</Link>
          </h2>
          <p>
        ...
        <section id="liability">
          <h2 className="mb-4 text-2xl">
            <Link href="#liability">23. LIMITATIONS OF LIABILITY</Link>
          </h2>
          <p>
        ...
        <section id="indemnification">
          <h2 className="mb-4 text-2xl">
            <Link href="#indemnification">24. INDEMNIFICATION</Link>
          </h2>
          <p>
        ...
        <section id="userdata">
          <h2 className="mb-4 text-2xl">
            <Link href="#userdata">25. USER DATA</Link>
          </h2>
          <p>
        ...
        <section id="california">
          <h2 className="mb-4 text-2xl">
            <Link href="#california">27. CALIFORNIA USERS AND RESIDENTS</Link>
          </h2>
          <p>
        ...
        <section id="misc">
          <h2 className="mb-4 text-2xl">
            <Link href="#misc">28. MISCELLANEOUS</Link>
          </h2>
          <p>
        ...
        <section id="contact">
          <h2 className="mb-4 text-2xl">
            <Link href="#contact">28. CONTACT US</Link>
          </h2>
          <p>
