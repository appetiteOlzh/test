...
import "./globals.css";
import { AudioUnlocker } from "@/shared/ui/audio-unlocker";
import { StayMutedProvider } from "@/shared/ui/video-player";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: "https://monclips.com/assets/img/og-bg.png", // Must be an absolute url
        },
      ],
    },
    twitter: {
